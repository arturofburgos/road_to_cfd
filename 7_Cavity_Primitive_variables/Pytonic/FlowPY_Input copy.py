...
colpts=277 #Number of grid points in the x-direction #KEEP ODD
rowpts =277 #Number of grid points in the y-direction #KEEP ODD#Create an object of the class Space called cavity
cavity=Space()
